...
if(get_pcd_CONFIG_INCLUDED)
  return()
endif()
set(get_pcd_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(get_pcd_SOURCE_PREFIX /home/tingxfan/ros_exp/src/get_pcd)
  set(get_pcd_DEVEL_PREFIX /home/tingxfan/ros_exp/devel)
  set(get_pcd_INSTALL_PREFIX "")
  set(get_pcd_PREFIX ${get_pcd_DEVEL_PREFIX})
else()
  set(get_pcd_SOURCE_PREFIX "")
  set(get_pcd_DEVEL_PREFIX "")
  set(get_pcd_INSTALL_PREFIX /home/tingxfan/ros_exp/install)
  set(get_pcd_PREFIX ${get_pcd_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'get_pcd' is deprecated")
...
set(get_pcd_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/tingxfan/ros_exp/src/get_pcd/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  set(get_pcd_INCLUDE_DIRS "")
  set(_include_dirs "/home/tingxfan/ros_exp/src/get_pcd/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'tingxfan <tingxfan@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${get_pcd_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'get_pcd' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'get_pcd' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tingxfan/ros_exp/src/get_pcd/${idir}'.  ${_report}")
    endif()
    _list_append_unique(get_pcd_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND get_pcd_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND get_pcd_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT get_pcd_NUM_DUMMY_TARGETS)
      set(get_pcd_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::get_pcd::wrapped-linker-option${get_pcd_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR get_pcd_NUM_DUMMY_TARGETS "${get_pcd_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::get_pcd::wrapped-linker-option${get_pcd_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND get_pcd_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/tingxfan/ros_exp/devel/lib;/home/tingxfan/ros_exp/devel/lib;/home/tingxfan/long_range_simulation/devel/lib;/home/tingxfan/nav_ws/devel/lib;/home/tingxfan/slam_ws/devel/lib;/home/tingxfan/dev_ws/devel/lib;/opt/ros/noetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(get_pcd_LIBRARY_DIRS ${lib_path})
      list(APPEND get_pcd_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'get_pcd'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND get_pcd_LIBRARIES ${lib})
    endif()
  endif()
...
set(get_pcd_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${get_pcd_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 get_pcd_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${get_pcd_dep}_FOUND)
      find_package(${get_pcd_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${get_pcd_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(get_pcd_INCLUDE_DIRS ${${get_pcd_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(get_pcd_LIBRARIES ${get_pcd_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${get_pcd_dep}_LIBRARIES})
  _list_append_deduplicate(get_pcd_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(get_pcd_LIBRARIES ${get_pcd_LIBRARIES})

  _list_append_unique(get_pcd_LIBRARY_DIRS ${${get_pcd_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(get_pcd_EXPORTED_TARGETS ${${get_pcd_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${get_pcd_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
